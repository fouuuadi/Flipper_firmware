...
// Fail-fast : si le SSID n'a pas été fourni (build_flags vide), on bloque avec
// un message clair plutôt que de boucler en silence. MQTT_BROKER_HOST reste
// facultatif (vide = passerelle WiFi, cf. connectMqtt).
void requireConfig() {
